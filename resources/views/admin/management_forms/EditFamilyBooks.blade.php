@extends('layouts.app')
@section('css')
    <title>{{ config('app.name') }} Edit Family Book</title>
    <!-- Default-->
...
@section('content')
<!-- Main content -->
<form class="form-horizontal my-4" action="/EditFamilyBooks/{{$Family_books->id}}" method="POST" autocomplete="on">
  @csrf
    <div class="row">
        <div class="col-xl-12">
          <div class="card">
            <h5 class="card-header bg-warning text-white mt-0"><i class="mdi dripicons-user mr-1"></i> تعديل بيانات دفتر عائلة  {{$Family_books->first_name}}{{_(' ')}}{{$Family_books->last_name}}  </h5>
            <div class="card-body">
                <div class="row form-material">
                    <div class="col-md-3">
                        <label for="id2" class="col-form-label text-right"> رقم الأستمارة </label>
                            <input type="number" class="form-control @error('id2') is-invalid @enderror" id="id2" name="id2" value="{{$Family_books->id2}}" autocomplete="id2" placeholder="0" autofocus required="">
                            @error('id2')
                    ...
                    <div class="col-md-3">
                        <label for="first_name" class="col-form-label text-right"> اسم المستفيد / ة </label>
                            <input type="text" class="form-control @error('first_name') is-invalid @enderror mx" id="first_name" name="first_name" value="{{$Family_books->first_name}}" autocomplete="first_name" placeholder="~" maxlength="25" autofocus required="">
                            @error('first_name')
                              <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                              </span>
                    ...
                    <div class="col-md-3">
                        <label for="last_name" class="col-form-label text-right"> كنية المستفيد / ة </label>
                            <input type="text" class="form-control @error('last_name') is-invalid @enderror mx" id="last_name" name="last_name" value="{{$Family_books->last_name}}" autocomplete="last_name" placeholder="~" maxlength="25" autofocus required="">
                            @error('last_name')
                              <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                              </span>
                    ...
                    <div class="col-md-3">
                        <label for="father_nqme" class="col-form-label text-right"> اسم الأب  المستفيد / ة </label>
                            <input type="text" class="form-control @error('father_nqme') is-invalid @enderror mx" id="father_nqme" name="father_nqme" value="{{$Family_books->father_nqme}}" autocomplete="father_nqme" placeholder="~" maxlength="25" autofocus required="">
                            @error('father_nqme')
                              <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                              </span>
                ...
                <div class="row form-material">
                    <div class="col-md-4">
                        <label for="national_id" class="col-form-label text-right"> الرقم الوطني للمستفيد  / ة </label>
                            <input type="number" class="form-control @error('national_id') is-invalid @enderror" id="national_id" name="national_id" value="{{$Family_books->national_id}}" autocomplete="national_id" placeholder="~" autofocus required="">
                            @error('national_id')
                              <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                              </span>
                    ...
                    <div class="col-md-3">
                        <label for="book_id" class="col-form-label text-right"> رقم دفتر العائلة  </label>
                            <input type="number" class="form-control @error('book_id') is-invalid @enderror" id="book_id" name="book_id" value="{{$Family_books->book_id}}" autocomplete="book_id" placeholder="~" autofocus required="">
                            @error('book_id')
                              <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                              </span>
                    ...
                    <div class="col-md-3">
                        <label for="birth_date" class="col-form-label text-right">  تاريخ ميلاد   المستفيد / ة </label>
                            <input type="date" class="form-control @error('birth_date') is-invalid @enderror" id="birth_date" name="birth_date" value="{{$Family_books->birth_date}}" autocomplete="birth_date"  autofocus required="">
                            @error('birth_date')
                              <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                              </span>
                    ...
                    <div class="col-md-2">
                      <label for="gender_participant" class="col-form-label text-right">  جنس المستفيد   </label>
                        <select class="form-control mb-3 @error('gender_participant') is-invalid @enderror" style="width: 100%; height:36px;" id="gender_participant" name="gender_participant" autocomplete="gender_participant" autofocus required >
                            <option selected="selected" value="{{$Family_books->gender_participant}}"> {{$Family_books->gender_participant}}  </option>
                ...
                <div class="row form-material">
                    <div class="col-md-4">
                      <label for="address_id" class="col-form-label text-right"> اختر العنوان   </label>
                        <select class="select2 form-control mb-3 custom-select @error('address_id') is-invalid @enderror" style="width: 100%; height:36px;" id="address_id" name="address_id" autocomplete="address_id" autofocus required >
                            <option selected="selected" value="{{$Family_books->address_id}}">{{$Family_books->addresse->address}}</option>
                    ...
                    <div class="col-md-8">
                        <label for="address_details" class="col-form-label text-right"> العنوان بالتفصيل  </label>
                            <input type="text" class="form-control @error('address_details') is-invalid @enderror mx" id="address_details" name="address_details" value="{{$Family_books->address_details}}" autocomplete="address_details" placeholder="~" maxlength="100" autofocus required="">
                ...
                <div class="row form-material">
                    <div class="col-md-6">
                        ...
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                ...
                                <input type="number" class="form-control @error('mobile') is-invalid @enderror" id="mobile" name="mobile" value="{{$Family_books->mobile}}" autocomplete="mobile" placeholder="~" autofocus required=>
                                @error('mobile')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col-md-6">
                        <label for="phone" class="col-form-label text-right"> رقم الهاتف   </label>
                            <input type="number" class="form-control @error('phone') is-invalid @enderror" id="phone" name="phone" value="{{$Family_books->phone}}" autocomplete="phone" placeholder="~" autofocus>
                            @error('phone')
                              <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                              </span>
                ...
                <div class="row form-material">
                    <div class="col-md-3">
                        <label for="husband_name" class="col-form-label text-right"> اسم الزوج  </label>
                            <input type="text" class="form-control @error('husband_name') is-invalid @enderror mx" id="husband_name" name="husband_name" value="{{$Family_books->husband_name}}" autocomplete="husband_name" placeholder="~" maxlength="30" autofocus required="">
                            @error('husband_name')
                              <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                              </span>
                    ...
                    <div class="col-md-3">
                      <label for="marital_status_id" class="col-form-label text-right"> الحالة الاجتماعية  </label>
                        <select class="select2 form-control custom-select mb-3 @error('marital_status_id') is-invalid @enderror" style="width: 100%; height:36px;" id="marital_status_id" name="marital_status_id" autocomplete="marital_status_id" autofocus required >
                            <option selected="selected" value="{{$Family_books->marital_status_id}}">{{$Family_books->marital_statu->status}}</option>
                    ...
                    <div class="col-md-3">
                        <label for="birth_date_husband" class="col-form-label text-right"> تاريخ ميلاد الزوج  </label>
                            <input type="date" class="form-control @error('birth_date_husband') is-invalid @enderror" id="birth_date_husband" name="birth_date_husband" value="{{$Family_books->birth_date_husband}}" autocomplete="birth_date_husband"  autofocus required="">
                    ...
                    <div class="col-md-3">
                      <label for="residence_status_id" class="col-form-label text-right">  حالة الاقامة   </label>
                        <select class="select2 form-control custom-select mb-3 @error('residence_status_id') is-invalid @enderror" style="width: 100%; height:36px;" id="residence_status_id" name="residence_status_id" autocomplete="residence_status_id" autofocus required >
                            <option selected="selected" value="{{$Family_books->residence_status_id}}">{{$Family_books->residence_statu->status}}</option>
                ...
                <div class="row form-material">
                    <div class="col-md-12">
                        <label for="notes" class="col-form-label text-right"> ملاحظات   </label>
                            <input type="text" class="form-control @error('notes') is-invalid @enderror mx" id="notes" name="notes" value="{{$Family_books->notes}}" autocomplete="notes" placeholder="~" maxlength="100" autofocus required="">
                            @error('notes')
                              <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                              </span>
                ...
                <div class="row form-material">
                    <div class="col-md-12">
                        <div class="repeater">
                            ...
                            @foreach ($Family_books->wives as $wife)
                                <div data-repeater-item class="row">
                                    <div class="col-md-5">
                                        <label for="wife_name" class="col-form-label text-right"> اسم الزوجة   </label>
                                            <input type="text" class="form-control @error('wife_name') is-invalid @enderror mx" id="wife_name" name="wife_name" value="{{$wife->name}}" autocomplete="wife_name" placeholder="~" maxlength="30" autofocus required="">
                                            @error('wife_name')
                                              <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                              </span>
                                    ...
                                    <div class="col-md-4">
                                        <label for="wife_birth_date" class="col-form-label text-right">  تاريخ ميلاد الزوجة  </label>
                                            <input type="date" class="form-control @error('wife_birth_date') is-invalid @enderror" id="wife_birth_date" name="wife_birth_date" value="{{$wife->birth_date}}" autocomplete="wife_birth_date"  autofocus required="">
                            ...
                            @endforeach
                                ...
                                <input type="hidden" id="count_wife" name="count_wife" value="{{$Family_books->wives->count()}}">
                            </div>
                ...
                <div class="row form-material">
                    <div class="col-md-12">
                        <div class="repeater">
                            ...
                            @foreach ($Family_books->childrens as $child)
                                <div data-repeater-item class="row">
                                    <div class="col-md-2">
                                        <label for="childe_name" class="col-form-label text-right"> اسم الولد   </label>
                                            <input type="text" class="form-control @error('childe_name') is-invalid @enderror mx" id="childe_name" name="childe_name" value="{{$child->name}}" autocomplete="childe_name" placeholder="~" maxlength="30" autofocus required="">
                                            @error('childe_name')
                                              <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                              </span>
                                    ...
                                    <div class="col-md-3">
                                        <label for="childe_birth_date" class="col-form-label text-right"> مواليد الولد  </label>
                                            <input type="date" class="form-control @error('childe_birth_date') is-invalid @enderror" id="childe_birth_date" name="childe_birth_date" value="{{$child->birth_date}}" autocomplete="childe_birth_date"  autofocus required="">
                                    ...
                                    <div class="col-md-2">
                                      <label for="gender" class="col-form-label text-right">  جنس الولد   </label>
                                        <select class="form-control mb-3 @error('gender') is-invalid @enderror" style="width: 100%; height:36px;" id="gender" name="gender" autocomplete="gender" autofocus required >
                                            <option selected="selected" value="{{$child->gender}}">{{$child->gender}}</option>
                                            <option value="ذكر"> ذكر  </option>
                                            <option value="أنثى">أنثى</option>
                                        </select>
                                        @error('gender')
                                    ...
                                    <div class="col-md-2">
                                      <label for="childe_status_id" class="col-form-label text-right">  الحالة  الصحية   </label>
                                        <select class="form-control mb-3 @error('childe_status_id') is-invalid @enderror" style="width: 100%; height:36px;" id="childe_status_id" name="childe_status_id" autocomplete="childe_status_id" autofocus required >
                                            <option selected="selected" value="{{$child->status_id}}">{{$child->children_statu->status}}</option>
                                    ...
                                    <div class="col-md-2">
                                        <label for="status_notes" class="col-form-label text-right"> ملاحظات  </label>
                                            <input type="text" class="form-control @error('status_notes') is-invalid @enderror mx" id="status_notes" name="status_notes" value="{{$child->status_notes}}" autocomplete="status_notes" placeholder="~" maxlength="30" autofocus>
                                            @error('status_notes')
                                              <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                              </span>
                            ...
                            @endforeach
                                ...
                                <input type="hidden" id="count_childe" name="count_childe" value="{{$Family_books->childrens->count()}}">
                            </div>
              ...
              <div class="card-footer">
                ...
                <a href="/ViewEditFamilyBooks"><button type="button" class="btn btn-warning btn-rounded waves-effect waves-light"><i class="mdi mdi-backup-restore mr-1"></i>  رجوع  </button></a>
              </div> 
          </div><!-- /.card -->
        </div><!-- end col -->
    </div><!-- end row -->
