@extends('layouts.app')
@section('css')
    <title>{{ config('app.name') }} Create Aid</title>
    <!-- Default-->
...
@section('content')
<!-- Main content -->
<form class="form-horizontal my-4" action="/CreateAid" method="POST" autocomplete="on">
  @csrf
    <div class="row">
        <div class="col-xl-12">
          <div class="card">
            <h5 class="card-header bg-info text-white mt-0"><i class="mdi mdi-file-document-outline mr-1"></i> ادخال بيانات معونة  </h5>
            <div class="card-body">
