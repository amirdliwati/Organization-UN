@extends('layouts.app')
@section('css')
    <title>{{ config('app.name') }} Create Scholarship</title>
    <!-- Default-->
...
@section('content')
<!-- Main content -->
<form class="form-horizontal my-4" action="/CreateScholarships" method="POST" autocomplete="on">
  @csrf
    <div class="row">
        <div class="col-xl-12">
          <div class="card">
            <h5 class="card-header bg-info text-white mt-0"><i class="mdi mdi-file-document-outline mr-1"></i> ادخال بيانات منحة  </h5>
            <div class="card-body">
                <div class="row form-material">
                    ...
                    <div class="col-md-6">
                        <label for="employee_name" class="col-form-label text-right"> اسم أمين المستودع  </label>
                            <input type="text" class="form-control @error('employee_name') is-invalid @enderror mx" id="employee_name" name="employee_name" value="{{ old('employee_name') }}" autocomplete="employee_name" placeholder="~" maxlength="100" autofocus>
                            @error('employee_name')
                              <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                              </span>
                    ...
                    <div class="col-md-12">
                        <div class="repeater">
                            <div data-repeater-list="items">
                                <div data-repeater-item class="row">
                                    <div class="col-md-6">
                                        <label for="item" class="col-form-label text-right"> المواد المسلمة  </label>
                                            <input type="text" class="form-control @error('item') is-invalid @enderror mx" id="item" name="item" value="{{ old('item') }}" autocomplete="item" placeholder="~" maxlength="100" autofocus required="">
                                            @error('item')
                                              <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                              </span>
                                    ...
                                    <div class="col-md-2">
                                        <label for="quantity" class="col-form-label text-right"> الكمية  </label>
                                            <input type="number" class="form-control @error('quantity') is-invalid @enderror" id="quantity" name="quantity" value="{{ old('quantity') }}" autocomplete="quantity" placeholder="~" autofocus required="">
                                            @error('quantity')
                                              <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                              </span>
                                ...
                                <input type="hidden" id="count_item" name="count_item" value="1">
                            </div>
