...
<div class="row">
    <div class="col-xl-12">
      <div class="card">
        <h5 class="card-header bg-success text-white mt-0"><i class="mdi dripicons-user mr-1"></i>  تعديل دفاتر العائلة  </h5>
        <div class="card-body">
            ...
            <table id="datatable-buttons" class="table table-bordered table-striped">
              ...
              <tbody>
                @foreach ($Family_books as $Family_book)
                  <tr>
                      <td><a href="/EditFamilyBooks/{{$Family_book->id}}"><button type="button" class="btn btn-warning btn-rounded waves-effect waves-light"><i class="mdi mdi-update mr-1"></i>  تعديل   </button></a></td>
                      <td><button type="button" class="btn btn-danger btn-rounded waves-effect waves-light" onclick="DeleteFB('{{$Family_book->id}}')"><i class="mdi dripicons-trash mr-2"></i>  حذف  </button></td>
