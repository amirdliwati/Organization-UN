...
<div class="row">
    <div class="col-xl-12">
      <div class="card">
        <h5 class="card-header bg-info text-white mt-0"><i class="mdi mdi-file-document-outline mr-1"></i>  التفاصيل  </h5>
        <div class="card-body">
            ...
            <table id="table-details" class="table table-bordered table-striped">
              ...
              <tbody>
                @foreach ($Details as $Detail)
                  <tr>
                      <td>{{$Detail->item}}</td>
                      <td>{{$Detail->measuring_unit->name}}</td>
